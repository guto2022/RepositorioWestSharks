...
public class TesteAutonomousAgroTech extends OpMode {
    ...
    private final Pose pickup1Pose = new Pose(26.91588785046729, 121.7943925233645, Math.toRadians(180));

    /** Middle (Second) Sample from the Spike Mark */
    private final Pose pickup2Pose = new Pose(27.36448598130841, 131.21495327102804, Math.toRadians(180));

    /** Highest (Third) Sample from the Spike Mark */
    private final Pose pickup3Pose = new Pose(28.934579439252335, 137.49532710280374, Math.toRadians(190));
